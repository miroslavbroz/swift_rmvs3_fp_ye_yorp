...
c in the HELIOCENTRIC frame, INCLUDING THERMAL EFFECT
c             Input:
...
c
c Remarks:  Added thermal effect.
c Modified by:  Miroslav Broz, miroslav.broz@usa.net
c Date:  Mar 5th 1999
...
c...  Now do j2 and j4 stuff
     ...
     &        irht,aoblxt,aoblyt,aoblzt)
      ...
      call getacc_yarko(nbod,ntp,mass,xh,yh,zh,

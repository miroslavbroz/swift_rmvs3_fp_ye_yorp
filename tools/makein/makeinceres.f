...
c  variables read from standard input
      double precision t0,elmts(6),mass
      integer ncent,m,mmassive
      logical baryc
      character*255 fmt
...
c  format of output double precision numbers
      read(*,10) fmt
c  number of massive bodies (except planets)
      read(*,*) mmassive
...
c
c  read initial positions and velocities of terrestrial planets from JPLEPH file
c
      write(*,*) 10+mmassive
      do i=1,5
      ...
      enddo
c
c  read elements of mmassive bodies and compute pv
c
      do i=1,mmassive
        read(*,*) elmts,mass
        do j=3,6

c  baryc.f
c
c  Apply barycenric correction for indirect effect of inner planets
c  to the initial conditions of outer ones and asteroids as printed
c  by makein program.
c
...
c-----------------------------------------------------------------------
c
c  read makein output (tp.in) from stadard input
c
...
c
c  apply the barycentric correction to outer planets and write
c  everything to the standard output in the same format as input
c
      write(*,*) npl - 4
      write(*,fmt) massb

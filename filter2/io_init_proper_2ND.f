...
c Aug 23rd 2006: an error message when open fails was added
      ...
      subroutine io_init_proper_2ND(infile,dtproper,outfile,iflgchk)
...
c  read input parameters
      ...
      if (ierr.ne.0) then
        write(*,*) 'io_init_proper_2ND: Error opening file ',infile,'.'
        call util_exit(1)
      endif

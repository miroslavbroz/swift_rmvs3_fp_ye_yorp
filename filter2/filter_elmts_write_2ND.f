c**********************************************************************
      subroutine filter_elmts_write_2ND(iu,elmts,n,nbod,ntp,istat,d,FM,
...
c  DO store planetary mean elements also (for FMFT filter in io_write_proper_2ND.f)
        mean_elmts(1,id) = a
        mean_elmts(2,id) = k
        mean_elmts(3,id) = h
        mean_elmts(4,id) = q
        mean_elmts(5,id) = p
        mean_elmts(6,id) = e          ! I use these for avg and min/max filter in io_write_proper_2ND.f
        mean_elmts(7,id) = inc
        mean_elmts(8,id) = sigma      ! I use this for mean resonant elements in io_write_proper_2ND.f
      enddo

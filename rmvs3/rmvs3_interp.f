...
!$OMP PARALLEL DO
!$OMP& PRIVATE (i, iflg)
!$OMP& SHARED (nbod, xbeg, ybeg, zbeg, vxbeg, vybeg, vzbeg,
!$OMP&   xend, yend, zend, vxend, vyend, vzend, xc1, yc1, zc1,
!$OMP&   vxc1, vyc1, vzc1, xc2, yc2, zc2, vxc2, vyc2, vzc2,
!$OMP&   msun, dtb)
      do i=2,nbod
...
!$OMP PARALLEL DO
!$OMP& PRIVATE (i, ib, iflg, frac, onemf)
!$OMP& SHARED (nbod, nt, dti, msun, dtb, xtmp, ytmp, ztmp,
!$OMP&   vxtmp, vytmp, vztmp, xc1, yc1, zc1, vxc1, vyc1, vzc1,
